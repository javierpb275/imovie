...
<div>
    ...
    <form class="px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="Email">
        </div>
        <div class="mb-4">
        ...
        <button class="bg-red-700 hover:bg-red-800 text-white font-bold py-2 px-10 rounded focus:outline-none focus:shadow-outline" type="button">
            ...
            <div class="mb-4">
            <router-link to="/signin" class=" align-baseline font-bold text-sm text-red-700 hover:text-red-800" href="#">
